...
void CyPlayerPythonInterface1(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("firstCity", &CyPlayer::firstCity, "tuple (bool bRev) - gets the first city")
		.def("nextCity", &CyPlayer::nextCity, "tuple (int iterIn, bool bRev) - gets the next city")
		...
		.def("firstUnit", &CyPlayer::firstUnit, "tuple (bool bRev) - gets the first unit")
		.def("nextUnit", &CyPlayer::nextUnit, "tuple (int iterIn, bool bRev) - gets the next unit")
		.def("getNumUnits", &CyPlayer::getNumUnits, "int ()")
		.def("getUnit", &CyPlayer::getUnit, python::return_value_policy<python::manage_new_object>(), "string (int eUnit)")
		.def("firstSelectionGroup", &CyPlayer::firstSelectionGroup, "tuple (bool bRev) - gets the first selectionGroup")
		.def("nextSelectionGroup", &CyPlayer::nextSelectionGroup, "tuple (int iterIn, bool bRev) - gets the next selectionGroup")
