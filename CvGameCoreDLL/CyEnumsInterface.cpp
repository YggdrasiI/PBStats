...
void CyEnumsPythonInterface()
{
	...
	python::enum_<ButtonPopupTypes>("ButtonPopupTypes")
		...
		.value("BUTTONPOPUP_CONFIRM_MENU_KI", BUTTONPOPUP_CONFIRM_MENU_KI)
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_NO_WONDER_RESOURCE", GAMEOPTION_NO_WONDER_RESOURCE)
		.value("GAMEOPTION_NO_IMMEDIATE_PEACE", GAMEOPTION_NO_IMMEDIATE_PEACE)
		.value("GAMEOPTION_TRUE_AI_DIPLO", GAMEOPTION_TRUE_AI_DIPLO)
