...
void CyStructsPythonInterface1()
{
	...
	python::class_<EventMessage>("EventMessage")
		...
		.def("getDescription", &EventMessage::getDescription, "const wchar* (uint uiForm)")
		;
	...
	python::class_<PBGameSetupData>("PBGameSetupData")
		...
		.def("getVictory", &PBGameSetupData::getVictory, "int ()")
		.def("getMapName", &PBGameSetupData::getMapName, "const TCHAR* ()")
