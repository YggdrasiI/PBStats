...
// Includes for save download
#include "curl/curl.h"
#define SKIP_PEER_VERIFICATION

#include "SaveTransfer.h"

/* Headers for faster save tranfer. */
...
static size_t curl_write_function(void *buffer, size_t size, size_t nmemb, void *stream)
{
