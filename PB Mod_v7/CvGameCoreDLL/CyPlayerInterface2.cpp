...
void CyPlayerPythonInterface2(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("AI_getNumAIUnits", &CyPlayer::AI_getNumAIUnits, "int (int (UnitAITypes) eIndex) - Returns # of UnitAITypes the player current has of UnitAIType")
		...
		.def("AI_getMemoryCount", &CyPlayer::AI_getMemoryCount, "int (int (PlayerTypes) eIndex1, int (MemoryTypes) eIndex2)")
		.def("AI_changeMemoryCount", &CyPlayer::AI_changeMemoryCount, "void (int (PlayerTypes) eIndex1, int (MemoryTypes) eIndex2, int iChange)")
		.def("AI_getExtraGoldTarget", &CyPlayer::AI_getExtraGoldTarget, "int ()")
		.def("AI_setExtraGoldTarget", &CyPlayer::AI_setExtraGoldTarget, "void (int iNewValue)")
		...
		.def("AI_maxGoldTrade", &CyPlayer::AI_maxGoldTrade, "int (int iPlayer)")
		.def("AI_maxGoldPerTurnTrade", &CyPlayer::AI_maxGoldPerTurnTrade, "int (int iPlayer)")
