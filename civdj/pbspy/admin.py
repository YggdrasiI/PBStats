...
admin.site.register(GameLogMetaChange)
admin.site.register(GameLogPause)
admin.site.register(GameLogTimerChanged)
admin.site.register(GameLogAdminAction)
admin.site.register(GameLogAdminSave)
admin.site.register(GameLogAdminPause)
admin.site.register(GameLogAdminEndTurn)
admin.site.register(GameLogForceDisconnect)
admin.site.register(GameLogMissedTurn)